'use strict';
document.addEventListener('DOMContentLoaded', initializeAnimationCvPlusContainer);

function initializeAnimationCvPlusContainer() {
    let container = document.querySelector('.project-container.cv-pls-pls');
